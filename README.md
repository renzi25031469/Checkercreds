...
![alt text](https://github.com/renzi25031469/Checkercreds/blob/main/checkercreds_banner.svg?raw=true)
...
╚██████╗██║  ██║███████╗╚██████╗██║  ██╗███████╗██║  ██║╚██████╗██║  ██║███████╗██████╔╝███████║
 ╚═════╝╚═╝  ╚═╝╚══════╝ ╚═════╝╚═╝  ╚═╝╚══════╝╚═╝  ╚═╝ ╚═════╝╚═╝  ╚═╝╚══════╝╚═════╝ ╚══════╝
         ...
         Default Credentials Checker — Hydra
  ⚠  Use somente em sistemas próprios ou com autorização  ⚠

  Uso: ./checkercreds.sh -i <arquivo> [opções]

  -i <arquivo>   Hosts alvo (um por linha)  (obrigatório)
  -o <dir>       Diretório de saída
  -t <n>         Tasks paralelas hydra (padrão: 4)
  -S             Pular SSH
  -T             Pular Telnet
  -R             Pular RDP
  -h             Exibe esta ajuda
